 ...
 * Admin API class.
 */
class Global_Balkan_Top_Header_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'global-balkan-top-header' ) . '" data-uploader_button_text="' . __( 'Use image', 'global-balkan-top-header' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'global-balkan-top-header' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'global-balkan-top-header' ) . '" />' . "\n";
