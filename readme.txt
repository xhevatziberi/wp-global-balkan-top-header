...
Installing "Global Balkan Top Header" can be done either by searching for "Global Balkan Top Header" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
